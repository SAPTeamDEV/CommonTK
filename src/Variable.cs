...
namespace SAPTeam.CommonTK
{
    ...
    public class Variable
    {
        ...
        /// </returns>
        public static string VariableActionGroup(string name, EnvironmentVariableTarget target)
        {
            return ActionGroup(ActionScope.Global, "variable", target.ToString(), name);
        }
        ...
        public static bool Exists(string name, bool throwException = false)
        {
            ...
            {
                throw new KeyNotFoundException($"The variable {name} is not found.");
            }
            else
            {
                return value != null;
