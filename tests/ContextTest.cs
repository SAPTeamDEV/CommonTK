...
public class ContextTest
{
    ...
    {
        using (DummyContext context = new DummyContext(true, false))
        {
            Assert.False(Exists<DummyContext>());
    ...
    public void IsGlobalReliabilityTest()
    {
        using (DummyContext2 context2 = new DummyContext2())
        {
            ...
            using (DummyContext2 context2b = new DummyContext2())
            {
                Assert.False(context2b.IsGlobal);

                using (DummyContext2 context2c = new DummyContext2(true))
                {
                    Assert.False(context2.IsGlobal);
                    Assert.False(context2b.IsGlobal);
    ...
    {
        using (DummyContext3 context3 = new DummyContext3())
        {
            Assert.Throws<ActionGroupException>(() => QueryGroup("application.test"));
            QueryGroup("application.test2");

            using (DummyContext2 context2 = new DummyContext2(true, true))
            {
                ...
                using (ProtectedExposerContext exposer = new ProtectedExposerContext())
                {
    ...
    {
        using (ProtectedExposerContext exposer = new ProtectedExposerContext(false))
        {
    ...
    public void InitializerCrashTest()
    {
        ...
        using (DummyContext2 context2 = new DummyContext2(earlyRegisterAction: true))
        {
            Assert.True(Exists<DummyContext2>());
        }

        using (DummyContext2 context2 = new DummyContext2(throwOnRegisterAction: true))
        {
    ...
    {
        DummyContext2 context2 = new DummyContext2(throwOnFinalizer: true);
        Assert.True(context2.IsGlobal);
